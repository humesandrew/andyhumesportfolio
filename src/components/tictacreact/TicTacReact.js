...
export default function TicTacReact() {
  return (
    <Card className="worksItemCard" sx={{ maxWidth: 800 }}>
      ...
      <CardActions>
        <Button size="small"><a href={resumeData.project[2].url} target="_blank" rel="noreferrer">Deployed</a></Button>
        <Button size="small"><a href={resumeData.project[2].url2} target="_blank" rel="noreferrer">Code</a></Button>
      </CardActions>
    </Card>
  );
}
